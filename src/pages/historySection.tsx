...
const webDesignHistoryEvents = [
  { image:'2007 Diasys d Germany.jpg',
    year: '2006\'s', description: ' DiaSys Diagnostic Systems GmbH partner in Mongolia since 2006.' ,
     Title:'The beginning'
     },
  { image:'2007 anhni seminar 3.jpg',
    year: '2007\'s', description: 'Started with Stardust MC-15 in 2007' ,
     Title:'First ever job' 
    },
  { image:'2011 on anhnii Buren automat analyzer in BGD EMT.jpg',
    year: '2011\'s', 
    description: 'Disterbuted first ever full automatic analyzer in BGL district hospital', 
    Title:'Javascript'  
  },
  { image:'2012 Germand ENg surgalt.jpg',
    year: '2012', 
    description: 'Pursuing more and more valuebles through ENG' ,
    Title:'Javascript'
     },
